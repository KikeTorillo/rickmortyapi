...
module.exports = {
  ...
  mode: 'development', //este modo se coloca para especifiar que se tiene la configuracion para el modo de desarrollo
  watch: true, //modo para estar detectando constantemente los cambios
  resolve: {
    extensions: [".js"],
  },
  module: {
  ...
  plugins: [
    ...
    new Dotenv(), //plugin que sirve para poder configurar variables de entorno
